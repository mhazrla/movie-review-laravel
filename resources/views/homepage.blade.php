            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-24">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div
                        ...
                        Announcing our movie review website. <a href="#" class="font-semibold text-indigo-600"><span
                                class="absolute inset-0" aria-hidden="true"></a>
                    </div>
                </div>
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Social film discovery</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">ScreenpunditID is a movie recommendation and review
