        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form class="space-y-4 text-gray-700" method="post" action="{{ route('movie.store') }}"
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full">
                                ...
                                <input name="judul" placeholder="Movie title" value="{{ old('judul') }}"
                        ...
                        <div class="flex flex-wrap -mx-2 space-y-4 md:space-y-0">
                            ...
                            <div class="w-full px-2 md:w-1/2">
                                ...
                                <input name="sutradara" placeholder="Movie's Directors" value="{{ old('sutradara') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="text" />
                                <div class="my-2 ">
                                    @error('sutradara')
                            ...
                            <div class="w-full px-2 md:w-1/2">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input name="tahun" placeholder="2020" value="{{ old('tahun') }}"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <select id="genre_id" name="genre_id"
                                    ...
                                    @foreach ($genres as $genre)
                                        <option value="{{ $genre->id }}"
                                            @if ($genre->id == old('genre')) selected @endif>
                                            {{ $genre->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="w-full px-2 md:w-1/2">
                                ...
                                <div class="mb-6">
                                    ...
                                    <select id="origin" name="origin"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option selected="" disabled>Choose origin</option>
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full">
                                ...
                                <textarea id="sinopsis" name="sinopsis" rows="4"
                                    ...
                                    placeholder="Synopsis...">{{ old('sinopsis') }}</textarea>
                                <div class="my-2 ">
                                    @error('sinopsis')
                                        <span class="text-red-600 text-sm">{{ $message }}</span>
                                    @enderror
